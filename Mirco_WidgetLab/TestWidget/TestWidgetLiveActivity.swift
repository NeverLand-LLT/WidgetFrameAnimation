...
struct TestWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = TestWidgetAttributes(name: "Me")
    static let contentState = TestWidgetAttributes.ContentState(value: 3)
